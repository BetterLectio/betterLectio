<script>
	...
	import { get, api } from '$lib/js/http.js';
...
{#if app_version && app_version != version}
	<div class="flex flex-col h-screen justify-center items-center">
		...
		<button on:click={() => app_version = undefined} class="mt-4 btn btn-error btn-wide">Forsæt uden at opdatere<br/>(Ikke anbefaldet)</button>
	</div>
{:else}
	<!-- error modal -->
	<ErrorMsg />
