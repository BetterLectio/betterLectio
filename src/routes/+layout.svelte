...
<div class="drawer h-screen">
  ...
  <div class="bg-base-300 h-100v w-16 z-30 inline lg:absolute p-1">
    <a href="/forside" class="group btn p-0 w-full mb-1 transition-[width] duration-500 hover:w-44 h-14 flex flex-row overflow-x-hidden">
      <svg
            version="1.1"
          ...
          >
            ...
            />
          </svg><span class=" opacity-0 w-0 group-hover:w-20 group-hover:opacity-100 transition-all duration-500">Forside</span>
    </a>
  </div>
