...
<div class="flex flex-row xl:justify-around">
  <div>
    <h1
      class="text-6xl font-extrabold md:text-8xl lg:text-9xl"
      in:fly={{ duration: 1000, y: 0, x: -50, easing: quintInOut }}
    >
      BetterLectio
    </h1>
    <p
      class="mb-6 text-2xl font-extrabold md:text-3xl lg:text-4xl"
    ...
    <div class="w-fit rounded-lg bg-base-content p-4">
      ...
      <div class="mt-4 flex flex-col md:flex-row">
        <a
          href={localStorage.getItem("lectio-cookie") ? "/forside" : "/auth"}
...
<div class="mt-6 rounded-lg bg-base-200 p-4">
  ...
  <p class="h-fit w-fit font-bold">
    BetterLectio er på nuværende tidspunkt under udvikling, det betyder at der kan forekomme fejl og mangler.
  </p>

  <p>
    BetterLectio er en forbredelse af Lectio. Lectio er et dansk webbaseret lektionssystem udviklet af det danske
    softwarefirma MaCom A/S. Vi har udviklet BetterLectio for at gøre det nemmere at bruge Lectio. Vi har fokuseret på at
    gøre det nemmere at finde informationer, og at gøre det nemmere at få overblik over sin skolegang. Vi har lavet en række
    andre forbedringer som f.eks. at lave en hel ny brugerflade, som både er mere brugervenlig og mere moderne.
  </p>

  <p class="mt-2 font-semibold">
    BetterLectio er et open source projekt, hvilket betyder at alle kan se koden, og alle kan bidrage til projektet. Hvis du
    har nogle forslag til forbedringer, eller hvis du har fundet en fejl, så er du meget velkommen til åbne en issue, eller
