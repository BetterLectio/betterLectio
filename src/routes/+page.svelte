...
<div class="container mx-auto w-full mt-4 z-30 relative" in:fade="{{duration: 1000}}">
	...
	<div class="mx-2 sm:mx-0">
		...
		<div class="flex flex-row xl:justify-around xl:items-center h-[75vh]">
			<div>
				<h1
		...
		<div
			id="om"
			class="grid grid-flow-row-dense grid-cols-1 mb:grid-cols-2 lg:grid-cols-3 gap-8 mb-40"
		>
			<div class="col-span-1">
				<div class="mt-6 rounded-lg bg-base-200 p-4">
					...
					<p class="h-fit w-fit font-bold">
						BetterLectio er på nuværende tidspunkt under udvikling, det betyder at der kan forekomme
						fejl og mangler.
					</p>

					<p>
						BetterLectio er en forbredelse af Lectio. Lectio er et dansk webbaseret lektionssystem
						udviklet af det danske softwarefirma MaCom A/S. Vi har udviklet BetterLectio for at gøre
						det nemmere at bruge Lectio. Vi har fokuseret på at gøre det nemmere at finde
						informationer, og at gøre det nemmere at få overblik over sin skolegang. Vi har lavet en
						række andre forbedringer som f.eks. at lave en hel ny brugerflade, som både er mere
						brugervenlig og mere moderne.
					</p>

					<p class="mt-2 font-semibold">
						BetterLectio er et open source projekt, hvilket betyder at alle kan se koden, og alle
						kan bidrage til projektet. Hvis du har nogle forslag til forbedringer, eller hvis du har
						fundet en fejl, så er du meget velkommen til åbne en issue, eller lave en pull request.
					</p>
				</div>
			</div>
		...
		{#if stats}
			<div id="stats" class="mb-40 bg-base-200 rounded-xl p-4">
				...
				<p class="mb-2">
					Selvom vi stadig er under konstant udvikling har vi alligevel fået ret mange brugere
				</p>
