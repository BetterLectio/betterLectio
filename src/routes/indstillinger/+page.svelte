<script>
  ...
  function downloadCookie() {
    ...
    element.setAttribute(
      "href",
      "data:text/plain;charset=utf-8," + encodeURIComponent(JSON.stringify(cookie, null, 2))
    );
...
<div class="flex flex-col">
  <ul use:checkUser class="menu bg-base-100 w-full p-2 rounded-box drop-shadow-xl md:w-56">
    ...
    <li class="tooltip" data-tip="Lectio bruger navn">
      <p id="user">
        <svg
    ...
    <li class="tooltip" data-tip="Dit elev ID">
      <p id="usid">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="16"
    ...
    <li class="tooltip" data-tip="Download din cookie">
      <p
        id="cookie"
        on:click={downloadCookie}
        on:keydown={() => {
