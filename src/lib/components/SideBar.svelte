...
>
  <div>
    <a href="/forside" class="btn-accent btn mb-1 flex flex-col content-center h-14 w-full tooltip tooltip-right" data-tip="Forside">
    ...
    <label for="søg-popup" class="btn mb-1 flex flex-col content-center h-14 w-full tooltip tooltip-right" data-tip="Søg">
    ...
    <div class="my-4" />
    <a href="/skema" class="btn btn-sm mb-1 flex flex-col content-center w-full tooltip tooltip-right" data-tip="Skema">
      <svg
    ...
    <a href="/opgaver" class="btn btn-sm mb-1 flex flex-col content-center w-full tooltip tooltip-right" data-tip="Opgaver">
    ...
    <a href="/lektier" class="btn btn-sm mb-1 flex flex-col content-center w-full tooltip tooltip-right" data-tip="Lektier">
    ...
    <a href="/fravær" class="btn btn-sm mb-1 flex flex-col content-center w-full tooltip tooltip-right" data-tip="Fravær">
    ...
    <a href="/dokumenter" class="btn btn-sm mb-1 flex flex-col content-center w-full tooltip tooltip-right" data-tip="Dokumenter">
    ...
    <a href="/beskeder" class="btn btn-sm mb-1 flex flex-col content-center w-full tooltip tooltip-right" data-tip="Beskeder">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="20"
        height="20"
    ...
    <a href="/karakterer" class="btn btn-sm mb-1 flex flex-col content-center w-full tooltip tooltip-right" data-tip="Karakterer">
    ...
    <a href="/værktøjer" class="btn btn-sm mb-1 flex flex-col content-center w-full tooltip tooltip-right" data-tip="Værktøjer">
  ...
  <div>
    <details class="dropdown-top dropdown z-50 mb-1 w-full" tabindex="0">
      <summary class="btn-sm btn w-full" for="theme-select" tabindex="0">
