...
>
	<div>
		<a href="/forside" class="btn-accent btn mb-1 flex flex-col content-center h-14 w-full tooltip tooltip-right" data-tip="Forside" tabindex="0">
		...
		<button for="søg-popup" class="btn mb-1 flex flex-col content-center h-14 w-full tooltip tooltip-right" data-tip="Søg" tabindex="0">
		...
		<div class="my-4" />
		<a href="/skema" class="btn btn-sm mb-1 flex flex-col content-center w-full tooltip tooltip-right" data-tip="Skema" tabindex="0">
			<svg
		...
		<a href="/opgaver" class="btn btn-sm mb-1 flex flex-col content-center w-full tooltip tooltip-right" data-tip="Opgaver" tabindex="0">
		...
		<a href="/lektier" class="btn btn-sm mb-1 flex flex-col content-center w-full tooltip tooltip-right" data-tip="Lektier" tabindex="0">
		...
		<a href="/fravær" class="btn btn-sm mb-1 flex flex-col content-center w-full tooltip tooltip-right" data-tip="Fravær" tabindex="0">
		...
		<a href="/dokumenter" class="btn btn-sm mb-1 flex flex-col content-center w-full tooltip tooltip-right" data-tip="Dokumenter" tabindex="0">
		...
		<a href="/beskeder" class="btn btn-sm mb-1 flex flex-col content-center w-full tooltip tooltip-right" data-tip="Beskeder" tabindex="0">
			<svg
				xmlns="http://www.w3.org/2000/svg"
				width="20"
				height="20"
		...
		<a href="/karakterer" class="btn btn-sm mb-1 flex flex-col content-center w-full tooltip tooltip-right" data-tip="Karakterer" tabindex="0">
		...
		<a href="/forms" class="btn btn-sm mb-1 flex flex-col content-center w-full tooltip tooltip-right" data-tip="Spørgeskemaer" tabindex="0">
			<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-mortarboard-fill" viewBox="0 0 16 16"
	...
	<div>
		<details class="dropdown-top dropdown z-50 mb-1 w-full">
			<summary class="btn-sm btn w-full" for="theme-select">
		...
		<a
			href="/discord"
			target="_blank"
			class="btn btn-sm mb-1 flex flex-col content-center w-full tooltip tooltip-right"
