...
import type { Information, RawInformation } from './types/information';
...
export const assignmentsPageSettingsStore = localStore<boolean>('assignmentsShowAll', false);
...
export const informationStore = lectioDataStore<Information | null, RawInformation>(
  '/informationer',
  'information',
  null,
  (data) => {
