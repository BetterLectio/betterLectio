<script lang="ts">
  ...
  import { authStore, googleSyncStore, assignmentsPageSettingsStore } from '$lib/stores';
...
<div class="page-container">
  ...
  <div class="space-y-4">
    ...
    <div>
      <h3 class="mb-2 text-lg font-semibold scroll-m-20">Opgave Siden</h3>
    </div>
    <Separator />
    <Alert.Root class="mb-2">
      <div class="flex items-center justify-between w-full">
        <div>
          <Alert.Title>Filtrer opgaver</Alert.Title>
          <Alert.Description>Filtrer opgaver efter nuværende skoleår</Alert.Description>
        </div>
        <div>
          <Switch bind:checked={$assignmentsPageSettingsStore} />
        </div>
      </div>
    </Alert.Root>
    <div>
